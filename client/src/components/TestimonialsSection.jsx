...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      id: 3,
      image: image3,
      quote: 'Reviva has transformed my daily routine completely. It helps me track my calorie intake, sleep patterns, and even motivates me to stay hydrated. I finally feel in control of my health journey!',
      author: 'Sultan Badra',
    ...
    },
    {
      id: 4,
      image: image4,
      quote: 'Reviva makes every aspect of wellness feel achievable. The daily reminders and tracking tools have become part of my routine, and I’ve never felt more productive. It’s definitely the best decision I’ve made for my health!',
      author: 'Rafi Islamy',
      role: 'New User',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 relative">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="relative group" onMouseEnter={() => setActivePopup(testimonial.id)} onMouseLeave={() => setActivePopup(null)}>
              ...
              {activePopup === testimonial.id && (
                <div className="absolute z-20 left-full top-1/2 ml-4 transform -translate-y-1/2 w-64 bg-white p-6 rounded-xl shadow-2xl border border-gray-100">
                  ...
                  {/* Arrow pointer */}
                  <div className="absolute -left-2 top-1/2 transform -translate-y-1/2 w-4 h-4 bg-white rotate-45 border-l border-t border-gray-100"></div>
                </div>
              )}
            </div>
          ))}
